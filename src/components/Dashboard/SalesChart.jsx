...
const data = [
    { name: 'Electronics', value: 45, fill: '#3b82f6', color: '#3b82f6' },
    { name: 'Clothing', value: 30, fill: '#8b5cf6', color: '#8b5cf6' },
    { name: 'Books', value: 15, fill: '#10b981', color: '#10b981' },
    { name: 'Others', value: 10, fill: '#f59e0b', color: '#f59e0b' },
]
